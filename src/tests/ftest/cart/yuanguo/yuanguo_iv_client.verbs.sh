...
D_PROVIDER="ofi+verbs;ofi_rxm" D_INTERFACE=bond0 /usr/lib/daos/TESTING/tests/iv_client -o update -r 0 -k 0:0 -v AAAA

#update key of rank0 by rank1
D_PROVIDER="ofi+verbs;ofi_rxm" D_INTERFACE=bond0 /usr/lib/daos/TESTING/tests/iv_client -o update -r 1 -k 0:1 -v BBBB

#fetch key of rank0 by rank0
D_PROVIDER="ofi+verbs;ofi_rxm" D_INTERFACE=bond0 /usr/lib/daos/TESTING/tests/iv_client -o fetch -r 0 -k 0:0
D_PROVIDER="ofi+verbs;ofi_rxm" D_INTERFACE=bond0 /usr/lib/daos/TESTING/tests/iv_client -o fetch -r 0 -k 0:1

#fetch key of rank0 by rank1
D_PROVIDER="ofi+verbs;ofi_rxm" D_INTERFACE=bond0 /usr/lib/daos/TESTING/tests/iv_client -o fetch -r 1 -k 0:0
D_PROVIDER="ofi+verbs;ofi_rxm" D_INTERFACE=bond0 /usr/lib/daos/TESTING/tests/iv_client -o fetch -r 1 -k 0:1
...
D_PROVIDER="ofi+verbs;ofi_rxm" D_INTERFACE=bond0 /usr/lib/daos/TESTING/tests/iv_client -o shutdown -r 0
ensure_attach_info_file
D_PROVIDER="ofi+verbs;ofi_rxm" D_INTERFACE=bond0 /usr/lib/daos/TESTING/tests/iv_client -o shutdown -r 1
